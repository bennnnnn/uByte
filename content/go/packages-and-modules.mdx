...
You will learn and practice: **Imports** (standard library: `strings`, `fmt`, `math`); **multiple packages** (`fmt` and `math`); **package-level variables**; **math/rand** for random numbers.
