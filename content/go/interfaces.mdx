...
You will learn and practice: **Define an interface** (method signatures; implicit implementation); **slice of interface** (range and call methods); **interface as parameter**; **type assertion** `v.(T)`; **empty interface (any)**.
