---
title: "Functions"
description: "Learn Go functions step by step: define them, pass values in, return values out, and build small reusable helpers."
order: 10
difficulty: "beginner"
estimatedMinutes: 12
---
...
- **Define and call** — `func name(params) returnType { }`, calling with arguments
- **Parameters** — give input values to a function
- **Return values** — send a value back from a function
- **Multiple return values** — return two values from one function
- **Variadic functions** — accept many values of the same type
