...
- **Multiple return values** — e.g. `(result, error)`; check error
- **Variadic functions** — `...type` for any number of arguments
- **Named return values** — names in signature, bare `return`
