...
- **if with init** — short statement before condition (e.g. `if v, ok := m[k]; ok { }`)
- **switch** — cleaner multi-way branching
- **FizzBuzz** — combine conditions and loops (multiples of 3, 5, 15)
