        ...
        {languages.map((lang) => {
          ...
          return (
            <Link
              ...
              className="group flex flex-col gap-3 rounded-xl border border-zinc-200 bg-[#f8f9fa] p-5 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md dark:border-zinc-700 dark:bg-zinc-800/80"
            >
