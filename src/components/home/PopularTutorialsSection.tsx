        ...
        {languages.map((lang) => {
          ...
          return (
            <Link
              ...
              className="group flex flex-col gap-3 rounded-xl border border-[#E7E1F3] bg-[#FAFCFF] p-5 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md dark:border-zinc-700 dark:bg-zinc-800/80"
            >
