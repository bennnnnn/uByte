...
const FEATURES = [
  ...
  "Test your real understanding",
  "Covers all core language concepts",
];
...
export default function PracticeExamsSection({ examConfigByLang }: Props) {
  return (
    <section aria-labelledby="certifications-heading" className="space-y-4">
      ...
      <div className="rounded-2xl border border-[#E5E7EB] bg-[#F7F8FF] px-6 py-8 shadow-sm sm:px-10 sm:py-10 dark:border-zinc-700 dark:bg-zinc-800/80">
