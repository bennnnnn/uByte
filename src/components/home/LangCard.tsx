...
export default function LangCard({ href, icon, name, badge, description, cta, color = "indigo" }: LangCardProps) {
  ...
  return (
    <Link
      href={href}
      className={`group flex flex-col rounded-xl border border-border-card bg-surface-card p-5 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md dark:border-zinc-700 dark:bg-zinc-800/80 ${t.hover}`}
    >
