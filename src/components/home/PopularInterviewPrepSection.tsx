        ...
        {problems.map((p) => {
          ...
          return (
            <Link
              ...
              className="group flex flex-col gap-3 rounded-xl bg-[#eef0ff] p-5 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md dark:bg-zinc-800/80"
            >
