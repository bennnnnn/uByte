...
export default function MobileNav({ lang, tutorials }: { lang: string; tutorials: NavItem[] }) {
  ...
  return (
    <div className="md:hidden">
        <div className="sticky top-0 relative z-20 flex items-center justify-between border-b border-zinc-100 bg-white/90 px-4 py-3 shadow-sm backdrop-blur-md dark:border-zinc-800 dark:bg-zinc-950/90">
