...
import React, { Suspense, useState, useEffect, useCallback, startTransition } from "react";
...
/* ── Tab definitions ───────────────────────────────────────────────────── */
const LEARNING_TABS = ["overview", "progress", "achievements", "leaderboard"] as const;
const ACCOUNT_TABS  = ["notifications", "settings"] as const;
...
function LeaderboardTab() {
  ...
  if (loading) {
    return (
      <div className="animate-pulse space-y-2 px-3 py-8 sm:px-6">
