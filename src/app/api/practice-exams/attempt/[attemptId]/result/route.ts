...
/** GET /api/practice-exams/attempt/[attemptId]/result — return score, passed, certificateId for a submitted attempt (owner only). */
export const GET = withErrorHandling(
  "GET /api/practice-exams/attempt/[attemptId]/result",
