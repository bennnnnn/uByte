          ...
          <div className="flex h-dvh flex-col overflow-hidden">
            ...
            <footer className="border-t border-zinc-100 bg-white px-6 py-3 dark:border-zinc-800 dark:bg-zinc-950 shrink-0">
              <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-xs text-zinc-500 dark:text-zinc-400">
                ...
                <Link href="/privacy" className="transition-colors hover:text-indigo-600 dark:hover:text-indigo-400">Privacy</Link>
                <Link href="/terms" className="transition-colors hover:text-indigo-600 dark:hover:text-indigo-400">Terms</Link>
                <Link href="/leaderboard" className="transition-colors hover:text-indigo-600 dark:hover:text-indigo-400">Leaderboard</Link>
                <Link href="/pricing" className="transition-colors hover:text-indigo-600 dark:hover:text-indigo-400">Pricing</Link>
                <a href="https://go.dev" target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-indigo-600 dark:hover:text-indigo-400">go.dev</a>
              </div>
            </footer>
          </div>
