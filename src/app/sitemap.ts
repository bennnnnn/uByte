...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const entries: MetadataRoute.Sitemap = [
    ...
    { url: absoluteUrl("/leaderboard"), lastModified: DEPLOY_DATE, changeFrequency: "daily", priority: 0.75 },    { url: absoluteUrl("/about"), lastModified: DEPLOY_DATE, changeFrequency: "monthly", priority: 0.6 },
